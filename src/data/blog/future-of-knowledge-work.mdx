...
Now they build them on their own with no technical background. They describe what they need and Claude Code gets it done for $100 per month. And they have what many engineers lack - domain expertise and enthusiasm. 
...
If intelligence is becoming commoditized, the only edge left is how and where you use it. Deciding that — inside a messy, real organization — is the job.
