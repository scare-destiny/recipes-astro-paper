...
const SocialIcon: React.FC<SocialIconProps> = ({ icon, href, label }) => {
  return (
    <motion.a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="p-3 rounded-xl bg-white/80 border border-gray-200 text-gray-600 hover:text-pink-600 hover:border-pink-300 hover:bg-pink-50 transition-all duration-300 backdrop-blur-sm shadow-sm hover:shadow-md"
